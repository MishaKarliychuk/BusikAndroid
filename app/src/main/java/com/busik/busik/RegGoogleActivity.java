...
public class RegGoogleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reg_google);
        sp = getSharedPreferences(MY_SETTINGS,
                Context.MODE_PRIVATE);

        google_email=MyApp.getGoogle_email();
        google_name=MyApp.getGoogle_name();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(RegGoogleActivity.this, MainActivity.class));
                finish();
            }
        });
        ...
        haveAcc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(RegGoogleActivity.this,LogActivity.class));
            }
        });
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(fio.getText().toString().trim().length()==0&&isCorect){
                    Toast.makeText(RegGoogleActivity.this,"Заполните ФИО",Toast.LENGTH_SHORT).show();
                    isCorect=false;
                }
                if(phone.getText().toString().trim().length()==0&&isCorect){
                    Toast.makeText(RegGoogleActivity.this,"Заполните телефон",Toast.LENGTH_SHORT).show();
                    isCorect=false;
                }
                if(countryTv.getText().equals("Країна проживання")&&isCorect){
                    Toast.makeText(RegGoogleActivity.this,"Виберіть країну",Toast.LENGTH_SHORT).show();
                    isCorect=false;
                }
                if(cityTv.getText().equals("Місто проживання")&&isCorect){
                    Toast.makeText(RegGoogleActivity.this, "Виберіть місто", Toast.LENGTH_SHORT).show();
                    isCorect=false;
                }
                if((pass.getText().toString().trim().length()==0&&isCorect)||(pass.getText().toString().trim().length()<=8&&isCorect)){
                    Toast.makeText(RegGoogleActivity.this, "Длина пароля должна біть больше 8 символов", Toast.LENGTH_SHORT).show();
                    isCorect=false;
                }
                if(!pass.getText().toString().trim().equals(pass2.getText().toString().trim())&&isCorect){
                    Toast.makeText(RegGoogleActivity.this, "Пароли не совпадают", Toast.LENGTH_SHORT).show();
                    isCorect=false;
                }
                if(!politica.isChecked()&&isCorect){
                    Toast.makeText(RegGoogleActivity.this, "Примите правила политики", Toast.LENGTH_SHORT).show();
                    isCorect=false;
                }
                if(isCorect){
                    if(asPassanger){
                        RequestBody requestBody = new MultipartBody.Builder()
                                ...
                                .addFormDataPart("gmail_email", google_email)
                                .build();
...
//                                            Toast.makeText(RegGoogleActivity.this,jsonObject.getString("error"),Toast.LENGTH_SHORT).show();
//                                        }
...
//                                    }
                                    ...
                                    try {
                                        ...
                                        Toast.makeText(RegGoogleActivity.this,jsonArray.get(0).toString(),Toast.LENGTH_SHORT).show();
                                    } catch (JSONException ex) {
                                        ex.printStackTrace();
                                    }
                    ...
                    Toast.makeText(RegGoogleActivity.this, "Заповніть коректно дані", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        country.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder b = new AlertDialog.Builder(RegGoogleActivity.this);
