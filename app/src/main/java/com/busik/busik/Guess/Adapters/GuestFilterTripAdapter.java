...
public class GuestFilterTripAdapter  extends RecyclerView.Adapter<GuestFilterTripAdapter.ViewHolder>{
    ...
    public GuestFilterTripAdapter(Context context, List<Buses> states, String token) {
        this.states = states;
        this.token = token;
        this.inflater = LayoutInflater.from(context);
    }
    @Override
    public GuestFilterTripAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = inflater.inflate(R.layout.item_trip, parent, false);


        return new GuestFilterTripAdapter.ViewHolder(view);
    }

    @SuppressLint("NewApi")
    @Override
    public void onBindViewHolder(GuestFilterTripAdapter.ViewHolder holder, int position) {
...
//        holder.timeArrive.setText(tArrive);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((GuessMainActivity) inflater.getContext()).setResultSearchAdapterPos(holder.getAdapterPosition());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        TextView nameDriver,departCity,arriveCity,timeDepart,timeArrive,passangerPrice,laggagePrice,tripsDate,rate;
