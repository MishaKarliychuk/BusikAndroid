...
public class TripAdapter  extends RecyclerView.Adapter<TripAdapter.ViewHolder>{
    ...
    int ppp;
    public TripAdapter(Context context, List<Buses> states,String token) {
        this.states = states;
        this.token = token;
    ...
    public void onBindViewHolder(TripAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((PassangerMainActivity) inflater.getContext()).setAllBusesAdapterPos(holder.getAdapterPosition());
        ...
        ppp=holder.getAbsoluteAdapterPosition();
    }
