...
public class FilterTripAdapter  extends RecyclerView.Adapter<FilterTripAdapter.ViewHolder>{
    ...
    public FilterTripAdapter(Context context, List<Buses> states, String token) {
        this.states = states;
        this.token = token;
        this.inflater = LayoutInflater.from(context);
    }
    @Override
    public FilterTripAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @SuppressLint("NewApi")
    @Override
    public void onBindViewHolder(FilterTripAdapter.ViewHolder holder, int position) {
...
//        holder.nameDriver.setText(state.getDriver().toString());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((PassangerMainActivity) inflater.getContext()).setTripDetailId(state.getId());
                ((PassangerMainActivity) inflater.getContext()).setResultSearchAdapterPos(holder.getAdapterPosition());
                ((PassangerMainActivity) inflater.getContext()).replaceFragment(new TripDetailFragment());
            }
        });
