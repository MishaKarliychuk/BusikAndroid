...
public class RegActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        haveAcc=findViewById(R.id.btn_i_have_acc);
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(fio.getText().toString().trim().length()==0&&isCorect){
                    Toast.makeText(RegActivity.this,"Заполните ФИО",Toast.LENGTH_SHORT).show();
                    isCorect=false;
                }
                if(phone.getText().toString().trim().length()==0&&isCorect){
                    Toast.makeText(RegActivity.this,"Заполните телефон",Toast.LENGTH_SHORT).show();
                    isCorect=false;
                }
                if(countryTv.getText().equals("Країна проживання")&&isCorect){
                    Toast.makeText(RegActivity.this,"Виберіть країну",Toast.LENGTH_SHORT).show();
                    isCorect=false;
                }
                if(cityTv.getText().equals("Місто проживання")&&isCorect){
                    Toast.makeText(RegActivity.this, "Виберіть місто", Toast.LENGTH_SHORT).show();
                    isCorect=false;
                }
                if((pass.getText().toString().trim().length()==0&&isCorect)||(pass.getText().toString().trim().length()<=8&&isCorect)){
                    Toast.makeText(RegActivity.this, "Длина пароля должна біть больше 8 символов", Toast.LENGTH_SHORT).show();
                    isCorect=false;
                }
                if(!pass.getText().toString().trim().equals(pass2.getText().toString().trim())&&isCorect){
                    Toast.makeText(RegActivity.this, "Пароли не совпадают", Toast.LENGTH_SHORT).show();
                    isCorect=false;
                }
                if(!politica.isChecked()&&isCorect){
                    Toast.makeText(RegActivity.this, "Примите правила политики", Toast.LENGTH_SHORT).show();
                    isCorect=false;
                }
                if(isCorect){
                    if(asPassanger){
...
//                                            Toast.makeText(RegActivity.this,jsonObject.getString("error"),Toast.LENGTH_SHORT).show();
//                                        }
...
//                                    }
                                    ...
                                    try {
                                        ...
                                        Toast.makeText(RegActivity.this,jsonArray.get(0).toString(),Toast.LENGTH_SHORT).show();
                                    } catch (JSONException ex) {
                                        ex.printStackTrace();
                                    }
...
//                                    }
                    ...
                    Toast.makeText(RegActivity.this, "Заповніть коректно дані", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        country.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder b = new AlertDialog.Builder(RegActivity.this);
